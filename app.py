...
def init_session():
    defaults = {
        ...
        "menu_selection": "보고서 AI 검토 Tools",
        "rfp_curr_text": "",
        "rfp_prev_text": "",
        "rfp_results": {},
        "rfp_project_name": "",
...
with st.sidebar:
    ...
    try:
        ...
        pass
    st.markdown("### 보고서 AI 검토 Tools & 과업 내용 체크")
    ...
    menu = st.radio(
        "메뉴를 선택하세요",
        ["보고서 AI 검토 Tools", "과업 내용 체크"],
        index=0 if st.session_state["menu_selection"] == "보고서 AI 검토 Tools" else 1,
...
""", unsafe_allow_html=True)
    ...
    if st.session_state["menu_selection"] == "보고서 AI 검토 Tools":
        # 상단 헤더 바
        st.markdown("""
    <div class="qx-topbar">
        <span class="qx-topbar-logo">보고서 AI 검토 Tools</span>
        <span class="qx-topbar-sep"></span>
        <span class="qx-topbar-title">수석 리서치 품질 검수관</span>
