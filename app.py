        ...
        if st.button("🚀 STEP 4. 자동 추출 시작 (행정망 중심 데이터 수집)", type="primary", use_container_width=True):
            ...
            try:
                search_inds = selected_industries if selected_industries else [
                    ...
                    # 2. B2B 화학/원자재/패키징 (15개)
                    "화학", "플라스틱", "고무", "세라믹", "유리", "섬유", "원단", "원사", "가죽", "종이", "펄프", "패키징", "박스", "폴리머", "실리콘",
                    # 3. B2B IT/소프트웨어/엔지니어링 (20개)
                    "테크", "코리아", "시스템", "정보통신", "소프트웨어", "디지털", "엔지니어링", "연구소", "과학", "솔루션", "플랫폼", "SI", "ERP", "MES", "CRM", "서버", "네트워크", "클라우드", "데이터", "인프라",
                    # 4. B2B 서비스/아웃소싱/컨설팅 (20개)
                    "아웃소싱", "헤드헌팅", "인재파견", "물류대행", "3PL", "포워딩", "특허", "관세", "기업평가", "인증", "시험원", "검사원", "컨설팅", "마케팅", "보안시스템", "관제", "통신장비", "노무", "세무", "회계",
                    # 5. B2B 도매/유통/무역/납품 (15개)
                    "상사", "유통", "무역", "대리점", "특판", "총판", "공급", "도매", "납품", "자재공급", "소모품", "MRO", "수출입", "글로벌", "종합",
                    # 6. B2C 및 기타 일반 업종군 (15개)
                    "건설", "건축", "미디어", "콘텐츠", "엔터테인먼트", "디자인", "기획", "인쇄", "출판", "금융", "투자", "캐피탈", "부동산", "식품", "푸드"
                ]
