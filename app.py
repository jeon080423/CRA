        ...
        if st.button("🚀 STEP 4. 자동 추출 시작 (행정망 중심 데이터 수집)", type="primary", use_container_width=True):
            ...
            try:
                search_inds = selected_industries if selected_industries else [
                    # 1. B2B 제조/부품/소재/정밀설비 (35개)
                    "부품", "소재", "원료", "자재", "설비", "기계", "금형", "사출", "프레스", "도금", "용접", "정밀가공", "금속가공", "와이어", "케이블", "파이프", "밸브", "모터", "베어링", "기어", "센서", "패널", "제어기", "컴프레셔", "자동화", "콘트롤", "반도체", "디스플레이", "PCB", "SMT", "광학", "레이저", "계측기", "도료", "페인트",
                    
                    # 2. B2B 화학/원자재/패키징/건설 (20개)
                    "화학", "플라스틱", "고무", "세라믹", "유리", "섬유", "원단", "원사", "가죽", "종이", "펄프", "패키징", "박스", "폴리머", "실리콘", "건설", "건축", "엔지니어", "토목", "조경",
                    
                    # 3. B2B IT/SW/엔지니어링/미디어 (25개)
                    "테크", "코리아", "시스템", "정보통신", "소프트웨어", "디지털", "연구소", "과학", "솔루션", "플랫폼", "SI", "ERP", "MES", "CRM", "서버", "네트워크", "클라우드", "데이터", "인프라", "보안시스템", "관제", "통신장비", "미디어", "콘텐츠", "엔터테인먼트",
                    
                    # 4. B2B 전문서비스/컨설팅/아웃소싱 (20개)
                    "아웃소싱", "헤드헌팅", "인재파견", "물류대행", "3PL", "포워딩", "특허", "관세", "기업평가", "인증", "시험원", "검사원", "컨설팅", "마케팅", "디자인", "기획", "인쇄", "출판", "노무", "환경",
                    
                    # 5. B2B & B2C 도소매/유통/무역/납품 (20개)
                    "상사", "유통", "무역", "대리점", "특판", "총판", "공급", "도매", "소매", "도소매", "납품", "자재공급", "소모품", "MRO", "수출입", "글로벌", "종합", "마트", "슈퍼", "백화점",
                    
                    # 6. B2C 식음료/급식/프랜차이즈 (20개)
                    "식품", "푸드", "식당", "맛집", "카페", "커피", "디저트", "베이커리", "제과", "반찬", "식자재", "고기", "육류", "수산물", "청과", "과일", "급식", "프랜차이즈", "도시락", "요리",
                    
                    # 7. B2C 생활/미용/쇼핑/여가 (25개)
                    "뷰티", "헤어", "네일", "미용", "피부", "스파", "세탁", "클리닝", "수리", "정비", "카센터", "공업사", "플라워", "꽃집", "인테리어", "가구", "침구", "의류", "패션", "악세사리", "잡화", "완구", "문구", "스튜디오", "사진",
                    
                    # 8. B2C 교육/스포츠/레저/관광 (25개)
                    "학원", "교육", "학교", "어린이집", "유치원", "스터디", "독서실", "헬스", "피트니스", "필라테스", "요가", "골프", "스포츠", "레저", "체육관", "수영장", "테니스", "여행", "관광", "숙박", "호텔", "펜션", "캠핑", "레포츠",
                    
                    # 9. B2C 의료/보건/한방/실버케어 (15개)
                    "병원", "의원", "클리닉", "약국", "의료기기", "요양", "실버", "간병", "보호센터", "치과", "한의원", "피부과", "안과", "내과", "성형",
                    
                    # 10. B2C 금융/전문직/부동산/행정 (15개)
                    "부동산", "공인중개사", "법무사", "변호사", "세무사", "회계사", "행정사", "금융", "은행", "보험", "증권", "투자", "캐피탈", "신협", "조리원"
                ]
