...
AUTO_MODEL_PRIORITY = [
    ...
    "gemini-2.0-flash",                 # 3순위: 안정적인 고속 모델
    "gemini-2.5-flash",                 # 4순위: 고기능 고속 모델
]
...
STEP_MODEL_MAP = {
    ...
    2: ["gemini-3-flash-preview", "gemini-2.5-flash", "gemini-2.0-flash"], 
    3: ["gemini-2.5-pro", "gemini-2.0-pro-exp-02-05", "gemini-3-flash-preview"], 
}
